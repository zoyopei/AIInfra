...
提到 Overlay 网络，首先对比一下常见的两种网络类型，Overlay 网络与 Underlay 网络的区别，架构设计如下图所示。
...
与 UDP 模式类似，当 container-1 发出请求后，发往地址 10.1.16.3 的 IP 包，会先出现在 docker 网桥，再路由到本机的 flannel.1 设备进行处理（进站）
