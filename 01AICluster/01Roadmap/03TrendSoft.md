...
![Broadcast 分发数据过程](images/03TrendSoft23.png)
...
![Gather 收集数据过程](images/03TrendSoft24.png)
...
![RDMA 概念](images/03TrendSoft25.jpg)
...
|​​结构分析​|CalculiX, Code_Aster|稀疏线性求解器（MUMPS, PETSc）|
